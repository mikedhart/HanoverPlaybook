---
title: Ruby/Rails Style Guide
section: guides
layout: page
---

# The Ruby/Rails Style Guide

Adapted from [Github's guide](https://github.com/styleguide/ruby) and [Bozhidar Batsov's guide](https://github.com/bbatsov/rails-style-guide).
...
* <a name="spaces-braces"></a>
  ...
  Use spaces around `{` and before `}` (except in blocks).
<sup>[[link](#spaces-braces)]</sup>
  ...
  `{` and `}` should use no spaces when declaring hash literals...
  ...
  ```
   ...
   ... but use spaces when declaring a block expression for visual difference
...
* <a name="consistent-string-literals"></a>
  Adopt a consistent string literal quoting style. Prefer double-quotes unless your string literal contains `"` or escape characters you want to suppress.
...
* <a name="local-smtp"></a>
  ...
  [LetterOpener](https://github.com/ryanb/letter_opener) in the development
  environment.
...
* <a name="foreman"></a>
  Use
  [foreman](https://github.com/ddollar/foreman) to easily manage running an application in development environment.
